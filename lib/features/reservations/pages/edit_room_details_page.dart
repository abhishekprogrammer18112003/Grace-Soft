// ignore_for_file: prefer_const_constructors, use_build_context_synchronously, curly_braces_in_flow_control_structures, non_constant_identifier_names
...
class EditRoomDetailsPage extends StatefulWidget {
  List<dynamic> rates;
  dynamic data;
  ...
  @override
  State<EditRoomDetailsPage> createState() => _EditRoomDetailsPageState();
}

class _EditRoomDetailsPageState extends State<EditRoomDetailsPage> {
  //====================Room Selection ===========================
  ...
  void initState() {
    ...
    super.initState();
    nightsController.text = widget.data["Nights"].toString();
    AdultController.text = widget.data["Guests"].toString();
    kidsController.text = widget.data["Children"].toString();
    infantsController.text = widget.data["Infants"].toString();
    rateNameController.text = widget.data["RateName"].toString();
    roomTypeController.text = widget.data["Room"]["RoomType"].toString();
    roomNameController.text = widget.data["Room"]["RoomName"].toString();
    arrival = widget.data["StartDate"].split("T")[0];
    departure = widget.data["EndDate"].split("T")[0];
    print(widget.rates);
    for (dynamic data in widget.rates) {
      if (data["RateName"] == rateNameController.text) {
        setState(() {
          selctedRateName = data;
        });
      }
    }
    print(selctedRateName);
  }
...
//==================Room Rate ======================
                ...
                ElevatedButton(
                    onPressed: () {
                      if (rateNameController.text == "" ||
                          ...
                          roomNameController.text == "") {
                        AppData.showErrorSnackbar(
                            context, "Please Fill the Required Filds");
                      }
                      else
                        addRoomDetails();
  ...
  Future<void> addRoomDetails() async {
    ...
    dynamic data = {
      ...
      "RoomAmount": selctedRateName["Rate"],
      "RoomAmountForTax": 0,
      "RoomAmounts":
    ...
    AppData.showErrorSnackbar(context , "Data Added Successfully !");
